...
class LensTest implements Command
{
	...
	public function run(&$stdout = null, &$stderr = null, &$exitCode = null)
	{
		...
		list($src, $cache, $contextPhp, $prePhp, $postPhp, $script, $mockClasses, $isCoverageEnabled) = $arguments;

		$processor = new Processor();
		$job = new TestJob($executable, $src, $cache, $contextPhp, $prePhp, $postPhp, $script, $mockClasses, $isCoverageEnabled, $processor, $process, $results, $coverage);
