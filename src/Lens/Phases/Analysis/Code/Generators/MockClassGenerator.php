...
class MockClassGenerator extends MockGenerator
{
	public function generate(array $context, array $class, array $map, array $inflatedTokens)
	{
		...
		$classPhp = $this->getClassPhp($class, $map, $inflatedTokens);
		$definitionPhp = Code::combine($contextPhp, $classPhp);
		return Code::getFilePhp($definitionPhp);
	}
